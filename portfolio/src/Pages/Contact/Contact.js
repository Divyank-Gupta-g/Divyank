                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-6 col-lg-6 col-xl-6 col-sm-12'>
                            ...
                            <div className='card2'>
                                ...
                                <span>
                                    <a href="https://www.linkedin.com/in/divyank-gupta-dg/" className='LinkedIn'><BsLinkedin size={50}/></a>
                                    <a href="https://github.com/Divyank-Gupta-g" className='GitHub'><BsGithub size={50} color="#000000"/></a>
                                    <a href="https://api.whatsapp.com/send?phone=+918923964795&text=Hello" className='WhatsApp'><MdWhatsapp size={50} color="#1EBE57"/></a>
                                </span>
                                </div>
                            </div>
                        </div>
